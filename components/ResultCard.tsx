...
import { TrendingUp, TrendingDown, Minus, ShieldCheck, Target, AlertTriangle } from 'lucide-react';
...
const ResultCard: React.FC<ResultCardProps> = ({ result }) => {
  ...
  return (
    <div className="w-full bg-market-card border border-market-border rounded-xl overflow-hidden shadow-2xl animate-fade-in">
      {/* Header */}
